...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"style="font-size: 2em;font-family: 'Nunito'">{{ __('Login') }}</div>
                ...
                <div class="card-body"style="background-color:#e8eaef;">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-sm-4 col-form-label text-md-right" style=  "font-size: 1.7em;font-family: 'Nunito'">{{ __('E-Mail') }}</label>
